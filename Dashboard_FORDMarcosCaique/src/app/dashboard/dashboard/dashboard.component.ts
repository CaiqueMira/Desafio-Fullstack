import { VehicleData, VehiclesDatas } from './../interfaces/vehicleData';
import { switchMap, filter, debounceTime, distinctUntilChanged, tap } from 'rxjs';
import { Veiculo, Veiculos } from './../interfaces/veiculo.model';
...
export class DashboardComponent implements OnInit {
  ...
  verifyVehicleData(arrayDatas: VehiclesDatas) {
